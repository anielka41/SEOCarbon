<div class="space-y-6">
    <div>
        <h1 class="text-2xl font-bold tracking-tight text-neutral-900">{{ __('Edit Entry') }}</h1>
        <p class="mt-1 max-w-2xl text-sm text-neutral-600">{{ __('Edytujesz własny wpis katalogu. Zmiany zapisują się do tego samego źródła prawdy.') }}</p>
    </div>
